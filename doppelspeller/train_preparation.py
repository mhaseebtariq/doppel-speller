...
from doppelspeller.common import get_train_data, get_min_hash, get_ground_truth
...
def train_preparation():
    ...
    with open(s.SIMILAR_TITLES_FILE, 'wb') as file_object:
        pickle.dump(similar_titles, file_object)
...
def generate_dummy_train_data():
    ...
    generated_training_data.reset_index().to_pickle(s.GENERATED_TRAINING_DATA_FILE)
